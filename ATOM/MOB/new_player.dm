/mob/new_player
	...
	gender = "male"
	var/lobby_text
	var/sound/lobbysound = sound('title1.ogg','title2.ogg','b12_combined_start.ogg')
...
/mob/new_player/Login()
	..()
	density = 0
	usr << "<h2><b>Добро пожаловать в Изометрическую станцию котораЯ модифицированна SanecMan. Вы находитесь на испытательной станции 'Aurora'. Задача станции: Испытывать новые изобретениЯ а так же не умереть.</b></h2>"
	usr << "<FONT COLOR=violet>ДИСКОРД: <a href='https://discord.gg/ehsrSvP'>HERE</a>"
	usr << "<FONT COLOR=blue>ГИТХАБ ОРИГИНАЛА: <a href='https://github.com/Derven/Lili-station'>HERE</a>"
	world << 'ping.ogg'
	world << "<FONT COLOR=#38BCFF>[ckey] зашёл в лобби!"
	lobby = new(usr)
